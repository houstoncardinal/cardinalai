                    ...
                    <div className="relative pt-24">
                            ...
                            <div className="sm:mx-auto lg:mr-auto">
                                ...
                                >
                                    ...
                                    <p
                                        ...
                                        PathwayAI is the ultimate thinking environment for developers. Build faster with AI agents that understand your style, predict your needs, and evolve with you.
                                    </p>
                                    <div className="mt-12 flex items-center gap-2">
                                        <div
                                            ...
                                            <Button
                                                ...
                                                <Link to="/ide">
                                                    <span className="text-nowrap">Launch IDE</span>
                                                </Link>
                                            </Button>
                                        </div>
                                        <Button
                        ...
                        <AnimatedGroup
                            ...
                            <div className="relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                                ...
                                />
                                <div className="relative mx-auto max-w-5xl overflow-hidden rounded-2xl border bg-background p-4 shadow-lg ring-1 ring-background">
                                    <img
                                        className="aspect-[15/8] relative hidden rounded-2xl bg-background dark:block"
                                        src="https://tailark.com/_next/image?url=%2Fmail2.png&w=3840&q=75"
                                        alt="PathwayAI IDE preview"
                                        width="2700"
                                        height="1440"
                                    />
                                    <img
